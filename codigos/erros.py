...
MENSAGENS_DE_ERRO = {
    ...
    commands.PrivateMessageOnly: 'Esse comando funciona apenas em mensagens privadas!',
    commands.NoPrivateMessage: 'Esse comando não funciona em mensagens privadas!',
    ...
    commands.UserNotFound: 'Não existe nenhum usuário com o nome ou ID fornecido!'
}