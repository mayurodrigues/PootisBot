...
MENSAGENS_DE_ERRO = {
    ...
    commands.BadColourArgument: "Erro: Cor inválida! Use um formato válido como `#ff0000` ou `red`.",
    ...
    commands.CommandOnCooldown: lambda error: f"Esse comando está em cooldown! Tente novamente em {round(error.retry_after)} segundos.",
